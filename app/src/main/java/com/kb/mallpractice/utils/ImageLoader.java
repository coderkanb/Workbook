package com.kb.mallpractice.utils;
...
import com.kb.mallpractice.MainApplication;
...
public class ImageLoader {
    ...
    public static void loadImage(Uri uri, SimpleDraweeView view) {
        GenericDraweeHierarchy hierarchy =
                new GenericDraweeHierarchyBuilder(MainApplication.getContext().getResources())
                        .setFadeDuration(300)
                        .setPlaceholderImage(R.mipmap.list_image_loading)
